  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: R.decorations.onboardingWrapperDecoration(),
        child: Column(
          children: [
...
// Slider images ends
            ...
            BottomExploreWrapper(handleClickSignIn: handleClickSignIn, handleClickSignup: handleClickSignup, handleClickWatchNow: handleClickWatchNow)
